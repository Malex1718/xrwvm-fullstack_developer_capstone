    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('type', models.CharField(choices=[('SEDAN', 'Sedan'), ('SUV', 'SUV'), ('WAGON', 'Station Wagon'), ('COUPE', 'Coupe'), ('MINIVAN', 'Minivan'), ('TRUCK', 'Truck'), ('CONVERTIBLE', 'Convertible'), ('HATCHBACK', 'Hatchback')], default='SEDAN', max_length=20)),
